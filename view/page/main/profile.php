...
<head>
    ...
    <link rel="stylesheet" href="<?=$VIEW_PAGE_FOLDER?>/style/profile.css">
    <script src="https://kit.fontawesome.com/0d40d8f017.js" crossorigin="anonymous"></script>

    <title>EduAR - Perfil</title>
</head>
<body>
    <?php require_once("$VIEW_CONTENT_PAGE_FOLDER/profile.php"); ?>

    <script>
        USER_DATA = <?php echo json_encode($user_data); ?>;
    </script>
    <script type="module" src="<?=$CONTROLLER_PAGE_FOLDER?>/profile.js"></script>
</body>
</html>